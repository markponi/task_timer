...
public class AppProvider extends ContentProvider {
    ...
    static final String CONTENT_AUTHORITY = "com.mjponi.tasktimer.provider";
    ...
    private static UriMatcher buildUriMatcher(){
        ...
        // e.g. content://com.mjponi.tasktimer.provider/Tasks
        matcher.addURI(CONTENT_AUTHORITY, TasksContract.TABLE_NAME, TASKS);
        //e.g. content://com.mjponi.tasktimer.provider/Tasks/8
        ...
        switch (match){
            case TASKS:
                ...
                if(recordId >= 0){
                    ...
                    throw new android.database.SQLException("Failed to inert into " + uri.toString());
                }
                break;
            case TIMINGS:
//                db = mOpenHelper.getWritableDatabase();
